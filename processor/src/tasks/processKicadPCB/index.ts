...
async function plotKicadGerbers(kicadPcbFile, tmpDir) {
  ...
  await sh`kicad-cli pcb export gerbers ${kicadPcbFile} --output ${tmpGerberFolder} --layers='*.Cu,B.Mask,F.Mask,B.Paste,F.Paste,F.SilkS,B.SilkS,Edge.Cuts' --subtract-soldermask`
